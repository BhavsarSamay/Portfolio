export const samayProfile = {
  ...
  github: 'https://github.com/BhavsarSamay',
  ...
  aiKnowledge: [
    ...
    },
    {
      ...
      answer:
        'Samay works across JavaScript (Node.js, Express, React), Python (FastAPI, Django), LangChain.js, RAG Pipelines, Agentic Systems, MongoDB, PostgreSQL, Redis, Socket.io, Stripe API, Docker, and Odoo 18.'
    },
    {
      keywords: ['projects', 'built', 'work', 'github'],
      answer:
        'Key projects include SiteAssist (full-stack RAG chat platform with embeddable widgets), Agentic AI TODO System (LangChain.js), RAG Enterprise Chatbot, Krsna App (MERN devotional platform), CosmicQuest (NASA APIs), and Echoing Ideas (publishing platform). Check his GitHub at https://github.com/BhavsarSamay.'
    },
    {
      keywords: ['hire', 'contact', 'reach', 'email', 'phone', 'linkedin'],
      answer:
        'You can reach Samay directly at samaybhavsar24oct@gmail.com, call +91-9265196524, connect on LinkedIn (https://www.linkedin.com/in/samay-bhavsar-b82a1b27a), or explore his GitHub (https://github.com/BhavsarSamay).'
    }
  ]
};
